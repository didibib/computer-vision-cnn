...
plt.imshow(load_img('st-40/images/applauding_001.jpg'))
plt.show()

# size = (224, 224)
# train_images = list(map(lambda loc: resize_with_pad(load_img('st-40/images/'+ loc), 224, 224), train_files))
# test_images = list(map(lambda loc: resize_with_pad(load_img('st-40/images/'+ loc), 224, 224), test_files))
