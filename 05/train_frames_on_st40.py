...
from models.frames_model import framesv2
...
class_names = util.get_class_names('st40_data/actions.txt')
...
train_images = util.get_images('st40_data/images_proc/', train_files)
...
test_images = util.get_images('st40_data/images_proc/', test_files)
...
frames = Model(framesv2, class_names, 'st40_frames')
frames.run(sh_train_img, sh_train_lbl, sh_test_img, sh_test_lbl)
print(frames._model.summary())