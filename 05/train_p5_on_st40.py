...
from models.p5_model import p5
...
train_images = util.get_images('st40_data/proc_images/', train_files)
...
test_images = util.get_images('st40_data/proc_images/', test_files)
