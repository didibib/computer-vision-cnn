...
# test set
set_1 = [f'{classes[c]}_{i:04d}' for c in range(len(classes)) for i in set_1_indices[c]]
...
# training set
set_2 = [f'{classes[c]}_{i:04d}' for c in range(len(classes)) for i in set_2_indices[c]]
